...
To use SEREIA, you just need to import the SEREIAS module (add import sereias to the top of your Python code) and then call its functions. For a primer about what functions to call and what order they need to be called, check the two notebooks that we provide in this folder (demo_sereias.ipynb and development_sereias.ipynb).
