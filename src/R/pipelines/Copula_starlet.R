...
fits_path <- "/Users/rd23aag/Documents/GitHub/crp8_segmentation/data/copula_transformed/copula_sagui12.fits"
  
X_or <- FITSio::readFITS("/Users/rd23aag/Documents/GitHub/crp8_segmentation/data/raw/datacube_sagui12.fits")
cube_or <- X_or$imDat
...
export_starlet_panels_png(
    ...
    dec = dec,
    J = J,
    out_dir = "/Users/rd23aag/Documents/GitHub/crp8_segmentation/results/figures/starlet_png/sagui12_cop",
    tag = "sagui12_cop",
    prefix = "starlet_2d",
    px = 1800,
    res = 300,
  ...
  cube_na  <- guara::mask_cube(cube_or, mask_rec, mode = "na")
 ...
 seg_cap  <-  segment_ward_landmarks(list(imDat = cube_na),N=12)
  ...
  FITSio::writeFITSim(
    cluster_map_vis,
    file   = "/Users/rd23aag/Documents/GitHub/crp8_segmentation/results/segmentation/copula_capivara/sagui12.fits",
  ...
  p <- plot_cluster_voronoi_style(
    seg_cap,
    palette = palette_van_gogh_div(12),
    border_color = "black",
    border_linewidth = 1,
    background_color = "transparent"
  )
  ragg::agg_png("/Users/rd23aag/Documents/GitHub/crp8_segmentation/results/figures/sagui_seg/sagui12_copula.png", width = 2000, height = 2000, res = 300)
  print(p)
  dev.off()
  ...
  readr::write_csv(flux_ordered_jy,"/Users/rd23aag/Documents/GitHub/crp8_segmentation/results/flux_per_region/SED_flux_wide_sagui12_copula.csv")
  




seg_cap <- FITSio::readFITS("/Users/rd23aag/Documents/GitHub/crp8_segmentation/results/segmentation/starlet_capivara/sagui12.fits")

sed <- read.csv("/Users/rd23aag/Documents/GitHub/crp8_segmentation/results/sed_fitting/sagui-12_sed_results.csv")
