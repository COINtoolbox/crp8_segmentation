...
4. How to save the information? One possibility is to borrow the format used in spatial models in geostatistics, see e.g. [Spatial data in R](https://r-spatial.github.io/sf/) for use of Geospatial Data Abstraction Library, which enables to manipulate data as vector geospatial data format (polygons, lines, etc), and operate then within a self-consistent algebraic framework. 
